...
testCompany
  = Node (Emp "Stan" 9)                  -- 1 (26, 19)
    [ Node (Emp "Bob" 2)                 -- 2 (9, 6)
      [ Node (Emp "Joe" 5)               -- 3 (5, 6)
        [ Node (Emp "John" 1) []         -- 4 (1, 0)
        , Node (Emp "Sue" 5) []          -- 4 (5, 0)
        ]
      , Node (Emp "Fred" 3) []           -- 3 (3, 0)
      ]
    , Node (Emp "Sarah" 17)              -- 2 (17, 4)
      [ Node (Emp "Sam" 4) []            -- 3 (4, 0)
      ]
    ]

testCompany2 :: Tree Employee
testCompany2
  = Node (Emp "Stan" 9)                  -- 1 (26, 21)
    [ Node (Emp "Bob" 3)                 -- 2 (9, 8)
      [ Node (Emp "Joe" 5)               -- 3 (5, 6)
        [ Node (Emp "John" 1) []         -- 4 (1, 0)
        , Node (Emp "Sue" 5) []          -- 4 (5, 0)
        ]
